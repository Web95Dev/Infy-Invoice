...
<table width="100%">
    <tr>
        <td colspan="2">
            ...
            {{$styleCss}}="border-bottom: 10px solid {{ $invoice_template_color }};">{{ __('messages.common.invoice') }}
            </div>
...
<table width="100%">
    ...
    <tr>
        <td class="vertical-align-top">
            ...
            <strong class="tu">{{ __('messages.invoice.invoice_id').':' }}&nbsp;</strong>#{{ $invoice->invoice_id }}<br>
