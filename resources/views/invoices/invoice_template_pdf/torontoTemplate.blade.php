...
<table width="100%">
    ...
    <tr>
        <td>
            ...
            @endif
            <span {{ $styleCss }}="color: {{ $invoice_template_color }};font-size: 20px" class="tu"
            >{{ __('messages.common.invoice') }}</span><br>
            ...
            <table class="items-table">
                ...
                @if(isset($invoice) && !empty($invoice))
                    @foreach($invoice->invoiceItems as $key => $invoiceItems)
                        <tr>
                            <td style="border-bottom: 1px solid {{ $invoice_template_color }}; padding: 5px;">{{ $key + 1 }}</td>
                            @if(!empty($invoiceItems->product->description) && $setting['show_product_description'] == 1)
                                <td style="width: 30%!important;border-bottom: 1px solid {{ $invoice_template_color }}; padding: 5px;">
                            @else
                            ...
                            <td class="number-align" style="border-bottom: 1px solid {{ $invoice_template_color }}; padding: 5px;">{{ number_format($invoiceItems->quantity,2) }}</td>
                            <td class="number-align" style="border-bottom: 1px solid {{ $invoice_template_color }}; padding: 5px;"><b class="euroCurrency">
                            ...
                            <td class="number-align" style="border-bottom: 1px solid {{ $invoice_template_color }}
                                    ; padding: 5px;"><b class="euroCurrency">
