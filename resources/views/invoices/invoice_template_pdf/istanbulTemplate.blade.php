...
<table width="100%">
    <tr>
        <td>
            ...
            ; color: white">{{ __('messages.common.invoice') }}</div>
            <div class="logo">
                ...
                <table width="20%" class="mt-2">
                    ...
                    <tr>
                        <td class="font-weight-bold"
                            style="white-space: nowrap">{{ __('messages.tax_information').':' }}&nbsp;
                        </td>
                    </tr>
                    </thead>
                    <tbody>
        ...
        <td>
            <table class="invoice-footer">
                ...
                <tr>
                    ...
                    border-bottom: 2px solid {{ $invoice_template_color }};">{{ __('messages.admin_dashboard.total_paid').':' }}</td>
