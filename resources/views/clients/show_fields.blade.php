                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                            <label for="name" class="pb-2 fs-4 text-gray-600">{{ __('messages.company_name')  }}
                                :</label>
                            <span class="fs-4 text-gray-800">{{ !empty($client->user->company_name) ? $client->user->company_name: 'N/A' }}</span>
                        </div>
                        <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                            <label for="name" class="pb-2 fs-4 text-gray-600">{{ __('messages.company_number')  }}
                                :</label>
                            <span class="fs-4 text-gray-800">{{ !empty($client->user->company_number) ? $client->user->company_number: 'N/A' }}</span>
                        </div>
                        <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
