...
<div class="col-lg-6">
        <div class="mb-5">
            ...
            {{ Form::text('company_name', null, ['class' => 'form-control', 'placeholder' =>  __('messages.company_name'), 'required']) }}
        </div>
    </div>
    <div class="col-lg-6">
        <div class="mb-5">
            {{ Form::label('company_number', __('messages.company_number').':', ['class' => 'form-label required mb-3']) }}
            {{ Form::text('company_number', null, ['class' => 'form-control', 'placeholder' =>  __('messages.company_number'), 'required']) }}
        </div>
    </div>
    <div class="col-lg-6">
        <div class="mb-5">
