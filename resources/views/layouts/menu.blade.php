...
<li class="nav-item {{ Request::is('admin/wallet*') ? 'active' : '' }}">
    <a class="nav-link d-flex align-items-center py-3" aria-current="page" href="{{ route('wallet.index') }}">
       <span class="menu-icon">
          <i class="fa-duotone fas fa-piggy-bank pe-3"></i>
        </span>
        <span class="aside-menu-title">{{ __('messages.wallet') }}</span>
    </a>
</li>
