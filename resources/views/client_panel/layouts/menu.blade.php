...
<li class="nav-item {{ Request::is('client/expenses*') ? 'active' : '' }}">
    <a class="nav-link d-flex align-items-center py-3" aria-current="page" href="{{ route('client.expenses.index') }}">
           <span class="menu-icon">
              <i class="fa-duotone fas fa-money-bill-trend-up pe-3"></i>
           </span>
